...
$local = "gauravbhardwaj5556@gmail.com";
$salt = '!@#6^&*(ASD$7F3%GHJ2L)';
$hashed =  crypt($local, $salt);
echo $hashed . "\n";
echo crypt($local, $salt);
//if(hash_equals($hashed, crypt($local . "kkkl", $salt))) {
//    echo "Yess 1\n";
//}
//
//if(hash_equals($hashed, crypt($local, $hashed))) {
//    echo "Yess 1\n";
//}
